...
write.table(results_transcripts, "SLN_vs_NCT_transcript_results.tsv", sep="\t", quote=FALSE, row.names = FALSE)
write.table(results_genes, "SLN_vs_NCT_gene_results.tsv", sep="\t", quote=FALSE, row.names = FALSE)
...
write.table(results_transcripts, "SLN_vs_NCT_transcript_results_filtered.tsv", sep="\t", quote=FALSE, row.names = FALSE)
write.table(results_genes, "SLN_vs_NCT_gene_results_filtered.tsv", sep="\t", quote=FALSE, row.names = FALSE)
