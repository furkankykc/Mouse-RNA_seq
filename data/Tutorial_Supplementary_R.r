...
gene_expression[1:3, c("FPKM.SLN_Rep1","FPKM.SLN_Rep2","FPKM.NCT_Rep1","FPKM.NCT_Rep2")]
...
# Find most significant gene by pval
most_sig_genes = arrange(sig_genes,pval)
...
gene_expression[,"SLN"]=apply(gene_expression[,c(1:3)], 1, mean)
gene_expression[,"NCT"]=apply(gene_expression[,c(4:6)], 1, mean)
